        ...
        slivers: [
          ...
          SliverList(
            delegate: SliverChildListDelegate([
                ...
                children: [
                  Container(
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(
                        color: Color.fromARGB(255, 57, 165, 113),
                      ),
                  ...
                  Container(
                    decoration: BoxDecoration(
                        color: Colors.greenAccent,
                        border: Border.all(
                          color: Color.fromARGB(255, 36, 193, 117),
                        ),
                        borderRadius:
                  ...
                  Container(
                    decoration: BoxDecoration(
                        color: Colors.greenAccent,
                        border: Border.all(
                          color: Color.fromARGB(255, 60, 174, 119),
                        ),
                        borderRadius:
                            const BorderRadius.all(Radius.circular(20))),
                    height: 25,
                  ...
                  Container(
                    decoration: BoxDecoration(
                        color: Colors.greenAccent,
                        border: Border.all(
                          color: Color.fromARGB(255, 58, 172, 117),
                        ),
                        borderRadius:
                            const BorderRadius.all(Radius.circular(20))),
                    height: 25,
              ...
              Image.asset("assets/images/BeFunky-photo.jpg"),
              const SizedBox(
                height: 10,
              ),
              Padding(
...
class VegGrid extends StatelessWidget {
  List<String> images = [
    "assets/images/BeFunky-photo (1).jpg",
